 ...
 * @Date: 2026-03-19 15:08:48
 * @LastEditors: majorzpley wyx1214844230@outlook.com
 * @LastEditTime: 2026-03-19 15:08:55
 * @FilePath: /05_rocketpi_smart_home/lib/motor_l9110/driver_motor_l9110_test.c
 * @Description:
 * 不用客气，这是你应该谢的!
 ...
 */
static void motor_l9110_test_enter(motor_l9110_test_state_t next_state,
                                   uint32_t hold_ms) {
  /* 进入新状态并记录起始时间 */
  s_state = next_state;

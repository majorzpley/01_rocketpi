 ...
 * @Date: 2026-03-19 15:06:12
 * @LastEditors: majorzpley wyx1214844230@outlook.com
 * @LastEditTime: 2026-03-19 15:06:21
 * @FilePath: /05_rocketpi_smart_home/lib/aht30/driver_aht30_test.c
 * @Description:
 * 不用客气，这是你应该谢的!
 ...
 */
static void aht30_test_print_status(const char *phase,
 ...
 * @return
 * 成功捕获数据返回HAL_OK，设备仍在测量时返回HAL_BUSY，否则返回HAL错误码。
 */

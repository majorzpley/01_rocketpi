 ...
 * @Date: 2026-03-19 15:06:56
 * @LastEditors: majorzpley wyx1214844230@outlook.com
 * @LastEditTime: 2026-03-19 15:07:03
 * @FilePath: /05_rocketpi_smart_home/lib/aht30/driver_aht30_test.h
 * @Description:
 * 不用客气，这是你应该谢的!
 ...
 * @return
 * 采样有效时返回HAL_OK，传感器仍在测量时返回HAL_BUSY，否则返回HAL错误码。
 */
 ...
 * @return
 * 成功获取原始字节返回HAL_OK，传感器仍在测量时返回HAL_BUSY，否则返回HAL错误码。
 */

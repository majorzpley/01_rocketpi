 ...
 * @LastEditTime: 2026-03-10 16:25:36
 * @FilePath: /01_rocketpi_serial_plane_game/src/main.c
 * @Description:飞行大乱斗
 * 不用客气，这是你应该谢的!
...
int main(void) {
  ...
  adc_joystick_send_udlr_uart(0, 20, &huart2); /*飞机大作战游戏*/
  while (1) {
  }
}
...
void SystemClock_Config(void) {
  ...
  // ADC分频配置PCLK2 =84M 84/4 = 21M = 47.6ns,对 STM32F4 来说，总转换时间 ≈
  // 采样时间 + 12.5 个周期 （112+12.5）x 47.6 每个通道一次转换大约 6 µs 左右

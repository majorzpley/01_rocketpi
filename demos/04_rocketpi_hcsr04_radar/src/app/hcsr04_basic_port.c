 ...
 * @Date: 2026-03-19 10:04:30
 * @LastEditors: majorzpley wyx1214844230@outlook.com
 * @LastEditTime: 2026-03-19 10:04:37
 * @FilePath: /04_rocketpi_hcsr04_radar/src/app/hcsr04_basic_port.c
 * @Description:
 * 不用客气，这是你应该谢的!
...
HCSR04_WEAK uint8_t hcsr04_basic_init(void) {
  ...
  DRIVER_HCSR04_LINK_TRIG_DEINIT(&s_hcsr04_handle,
                                 hcsr04_interface_trig_deinit);
  ...
  DRIVER_HCSR04_LINK_ECHO_DEINIT(&s_hcsr04_handle,
                                 hcsr04_interface_echo_deinit);
  DRIVER_HCSR04_LINK_ECHO_WRITE(&s_hcsr04_handle, hcsr04_interface_echo_read);
  DRIVER_HCSR04_LINK_TIMESTAMP_READ(&s_hcsr04_handle,
                                    hcsr04_interface_timestamp_read);
  ...
  DRIVER_HCSR04_LINK_DEBUG_PRINT(&s_hcsr04_handle,

 ...
 * @Date: 2026-03-19 10:04:49
 * @LastEditors: majorzpley wyx1214844230@outlook.com
 * @LastEditTime: 2026-03-19 10:04:57
 * @FilePath: /04_rocketpi_hcsr04_radar/src/app/ring_buffer.c
 * @Description:
 * 不用客气，这是你应该谢的!
...
size_t RingBuffer_Size(const RingBuffer *rb) { return rb->size; }

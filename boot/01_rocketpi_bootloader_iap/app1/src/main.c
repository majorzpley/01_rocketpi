 ...
 * @LastEditTime: 2026-03-10 14:03:48
 * @FilePath: /01_rocketpi_bootloader_iap/app1/src/main.c
 * @Description:此工程为rocketpi bootloader iap工程app1项目
 * 不用客气，这是你应该谢的!
...
/* 声明外部变量，来自链接脚本 */
extern uint32_t __bootloader_end;

static void SystemClock_Config(void);

int main(void) {
  //* 设置向量表偏移量 */
  // todo SCB->VTOR 的值必须按 256 字节（0x100）对齐
  uint32_t vtor_value = (uint32_t)&__bootloader_end;
  SCB->VTOR = vtor_value;

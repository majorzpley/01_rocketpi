 ...
 * @Date: 2026-02-05 12:45:28
 * @LastEditors: majorzpley wyx1214844230@outlook.com
 * @LastEditTime: 2026-02-05 13:27:04
 * @FilePath: /07_rocketpi_uart_echo/src/usart.c
 * @Description:
 * 不用客气，这是你应该谢的!
...
void MY_USART2_UART_Init(void) {
  ...
  huart2.Init.WordLength = UART_WORDLENGTH_8B;     //数据位8
  huart2.Init.StopBits = UART_STOPBITS_1;          //停止位1
  ...
  huart2.Init.OverSampling = UART_OVERSAMPLING_16; //过采样16

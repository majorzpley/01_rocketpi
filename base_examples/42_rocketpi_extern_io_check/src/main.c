 ...
 * @LastEditTime: 2026-03-08 13:13:25
 * @FilePath: /42_rocketpi_extern_io_check/src/main.c
 * @Description:此工程为rocketpi让io 500ms翻转,验证是否虚焊
 * 不用客气，这是你应该谢的!
...
int main(void) {
  ...
  while (1) {
    HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_2 | GPIO_PIN_6 | GPIO_PIN_7 |
                                  GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_11);

    HAL_GPIO_TogglePin(GPIOA,
                       GPIO_PIN_6 | GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_10);

    HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_12 |
                                  GPIO_PIN_13 | GPIO_PIN_15 | GPIO_PIN_4 |

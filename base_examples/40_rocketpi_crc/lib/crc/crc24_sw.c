 ...
 * @Date: 2026-03-07 14:45:32
 * @LastEditors: majorzpley wyx1214844230@outlook.com
 * @LastEditTime: 2026-03-07 14:45:42
 * @FilePath: /40_rocketpi_crc/lib/crc/crc24_sw.c
 * @Description:
 * 不用客气，这是你应该谢的!
...
uint32_t __weak crc24_pgp(const uint8_t *data, size_t len) {
  return crc24_pgp_update(CRC24_PGP_INITIAL_VALUE, data, len) &
         CRC24_FINAL_VALUE_MASK;
}

/* CRC-24 implementation from the section 6.1 of the RFC 4880 */
uint32_t __weak crc24_pgp_update(uint32_t crc, const uint8_t *data,
                                 size_t len) {
  int i;

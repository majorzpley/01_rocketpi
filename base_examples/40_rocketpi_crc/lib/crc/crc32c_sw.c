 ...
 * @Date: 2026-03-07 17:20:05
 * @LastEditors: majorzpley wyx1214844230@outlook.com
 * @LastEditTime: 2026-03-07 17:20:14
 * @FilePath: /40_rocketpi_crc/lib/crc/crc32c_sw.c
 * @Description:
 * 不用客气，这是你应该谢的!
...
uint32_t __weak crc32_c(uint32_t crc, const uint8_t *data, size_t len,
                        bool first_pkt, bool last_pkt) {
  if (first_pkt) {
    crc = CRC32C_INIT;
  }

...
#define WS2812B_MAX_LEDS                                                       \
  300U /**< Maximum number of LEDs supported by this build. */
#define WS2812B_RESET_SLOTS                                                    \
  80U /**< Number of low slots appended to provide reset (>50us). */
#define WS2812B_T0H_TICKS                                                      \
  32U /**< Timer ticks representing a logic-0 high pulse. */
#define WS2812B_T1H_TICKS                                                      \
  70U /**< Timer ticks representing a logic-1 high pulse. */
#define WS2812B_TIMER_CHANNEL                                                  \
  TIM_CHANNEL_4 /**< TIM channel used for PWM output. */
 ...
 */
bool ws2812b_set_pixel(uint16_t index, uint8_t red, uint8_t green,
                       uint8_t blue) {
 ...
 */
bool ws2812b_is_busy(void) { return ws_dma_busy; }

/**
 * @brief Return configured LED count.
 */
uint16_t ws2812b_get_led_count(void) { return ws_led_count; }

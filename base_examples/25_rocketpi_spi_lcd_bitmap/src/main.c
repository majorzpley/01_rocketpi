 ...
 * @LastEditTime: 2026-02-16 13:36:33
 * @FilePath: /25_rocketpi_spi_lcd_bitmap/src/main.c
 * @Description:生成png图片的h文件并显示png图片
 * 不用客气，这是你应该谢的!
...
#include "JayChou_rgb565_240x240.h"
...
int main(void) {
  ...
  ST7789_DrawBitmap(0, 0, 240, 240, (uint8_t *)JayChou_rgb565_240x240);
  while (1) {
  }
}
